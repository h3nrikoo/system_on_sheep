...
#define SDC_MOSI_PIN    NRF_GPIO_PIN_MAP(0, 28)
#define SDC_MISO_PIN    NRF_GPIO_PIN_MAP(0, 29)
#define SDC_CS_PIN      NRF_GPIO_PIN_MAP(0, 31)

#define SOS_MAX_LOG_ELEMENTS 30

#define SOS_LOG_STATUS_OK 0
#define SOS_LOG_STATUS_FULL 1
#define SOS_LOG_STATUS_SAVED 2
#define SOS_LOG_STATUS_FAILED 3
